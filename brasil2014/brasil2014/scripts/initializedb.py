...
def main(argv=sys.argv):
    ...
    with transaction.manager:
        ...
        DBSession.add(Match(id= 8, begin=datetime(2014,6,15, 00,00), team1='ENG', team2='ITA'))
        ...
        DBSession.add(Match(id=18, begin=datetime(2014,6,19, 00,00), team1='CMR', team2='CRO'))
